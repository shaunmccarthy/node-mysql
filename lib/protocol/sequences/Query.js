...
function Query(options, callback) {
  ...
  this.labelData = (options.labelData === undefined) ? true : options.labelData;
...
Query.prototype['RowDataPacket'] = function(packet, parser, connection) {
  packet.parse(parser, this._resultSet.fieldPackets, this.typeCast, this.nestTables, this.labelData, connection);

  if (this._callback) {
    this._resultSet.rows.push(this.labelData ? packet : packet.data);
  } else {
    this.emit('result', this.labelData ? packet : packet.data, this._index);
  }
};
